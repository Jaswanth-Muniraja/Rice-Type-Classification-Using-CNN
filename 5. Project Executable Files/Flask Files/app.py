...
ver_fn = getattr(tf.keras, "version", None)
if ver_fn and ver_fn().startswith("3."):
    import tf_keras as keras
else:
    keras = tf.keras

model = keras.models.load_model(filepath='rice.h5', custom_objects={'KerasLayer': hub.KerasLayer})
